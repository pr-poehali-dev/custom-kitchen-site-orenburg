...
const PROCESS = [
  ...
  { n: '04', title: 'Изготовление', text: 'Производим кухню в собственном цехе за 20–60 рабочих дней.' },
...
const FAQ = [
  ...
  { q: 'Сколько изготавливается кухня?', a: 'В среднем 20–60 рабочих дней с момента согласования проекта.' },
